...
Page({
  ...
  data: {
    ...
    balanceArr: [
      {
        payChannel: 'wxpay', createTime: '2017-07-26  17:00:01', money: '100.00', type: 'consume', credit: 0
      },
      {
        payChannel: 'wxpay', createTime: '2017-07-26  17:00:01', money: '700.00', type: 'charge', credit: 0
      },
      {
        payChannel: 'alipay', createTime: '2017-07-26  17:00:01', money: '100.00', type: 'consume', credit: 0
      },
      {
        payChannel: 'balance', createTime: '2017-07-26  17:00:01', money: '100.00', type: 'consume', credit: 0
      },
      {
        payChannel: 'alipay', createTime: '2017-07-26  17:00:01', money: '700.00', type: 'charge', credit: 0
      }
    ],
    isList: true,   // 用于判断balanceArr数组是不是空数组，默认true，空的数组
  ...
  getList: function(){
    ...
    getBalance(pageNum,callbackcount, function(data){
      ...
      if(data.data.balance !== 0){
        ...
        that.data.isList ? newBalanceArr = data.data.balance : newBalanceArr = that.data.balanceArr.concat(data.data.balance)
        that.setData({
          balanceArr: newBalanceArr, //获取数据数组
